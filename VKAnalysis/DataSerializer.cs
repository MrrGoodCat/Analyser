...
namespace VKAnalysis
{
    class DataSerializer<T>
    {
        ...
        /// <summary>
        /// Default constructor that initiates XMLSerializer for specified Type. 
        ...
        public DataSerializer(string xmlPath)
        {
            xmlFilePath = xmlPath;
        }
        #endregion
        ...
        /// <summary>
        /// Serialize the given object to the XML. XML file has been specified during XMLSerializer initiation.
        /// </summary>
        ...
        /// <summary>
        /// Deserialize XML file to the object of the given Type. XML file has been specified during XMLSerializer initiation.
        /// </summary>
        ...
        /// <returns>Object of the specified Type (has specified during XMLSerializer declaration).</returns>
